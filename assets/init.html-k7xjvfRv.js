import{_ as n,c as a,e,o as i}from"./app-xIhBe7fy.js";const l={};function t(p,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h2 id="init" tabindex="-1"><a class="header-anchor" href="#init"><span>Init</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> config  user.name <span class="token string">&quot;Alice&quot;</span></span>
